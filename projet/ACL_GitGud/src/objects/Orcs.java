...
public class Orcs extends GameObject{
	...
	private BufferedImage orcs_image;


	int choose=0;
	int hp=100;
	public Orcs(int x, int y, ID id, Handler handler,  SpriteSheet ss) {
		super(x,y,id, ss);
		this.handler = handler;
		size=32;
		orcs_image = ss.grabImage(4, 1, size, size);
	}
	public void tick() {
		x+=velX;
		y+=velY;
	...
	public void render(Graphics g) {
		g.drawImage(orcs_image,(int) x, (int)y, null);
