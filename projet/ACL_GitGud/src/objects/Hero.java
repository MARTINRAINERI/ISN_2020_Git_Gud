...
public class Hero extends GameObject{
	...
	private void collision() {
		for(int i=0;i<handler.object.size();i++) {
			...
			if(tempObject.getId() == ID.wall || tempObject.getId() == ID.border || tempObject.getId() == ID.orcs || tempObject.getId() == ID.ghosts) {
			...
			if(tempObject.getId() == ID.orcs || tempObject.getId() == ID.ghosts) {
